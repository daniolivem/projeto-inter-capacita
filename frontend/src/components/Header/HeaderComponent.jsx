                    ...
                    <div className='header-main'>
                        <button className='hamburger-menu' onClick={handleMenuClick}>
                            {isMenuOpen ? (
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w.org/2000/svg"><path d="M3 12H21M3 6H21M3 18H21" stroke="#2D2D36" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            )}
                        </button>
